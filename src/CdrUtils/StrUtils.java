...
public class StrUtils {
	...
	public static void main(String args[]) throws ParseException, IOException
	{
		...
		//String ss[]=StringUtils.splitPreserveAllTokens(s, ",");
		//String ss[]=split(s,",");
		//System.out.println("==>"+s.length());
			//String s2="\x00\x00\x00\x96";38,1445561365843,17052520720,8519629
	...
	//	long end=System.currentTimeMillis();
		...
		//System.out.println(datestr2long3("201501"));
		//System.out.println(datestr2long("20150201000000000"));//yyyyMMddHHmmssSSS
		...
		BufferedReader br=new BufferedReader(new FileReader(new File("/data/f_hlr2_lb_month-201508.dat")));
		String tmp;
	...
	public static long datestr2long3(String datestr) throws ParseException
	{
		//2015-10-21 14:47:17.176
		//SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS");
		Date d=DF3.parseDateTime(datestr).toDate();
		return d.getTime();
	...
	public static boolean isBlankorZeroString(final String str)
	{
